...
var SmartQueue = /** @class */ (function () {
    ...
    SmartQueue.prototype.execute = function (queue) {
        return __awaiter(this, void 0, void 0, function () {
            var retryState, retryTimer, retryFn, nextItem, startTime, data, endTime, executionTime, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        startTime = Date.now();
                        return [4 /*yield*/, nextItem.item.request(retryFn)];
                    case 3:
                        data = _a.sent();
                        endTime = Date.now();
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/, this.execute()];
                }
            });
        });
    };
    ...
    SmartQueue.prototype.heat = function (part) {
        var _this = this;
        ...
        setTimeout(function () {
            _this.overheat = Math.max(_this.overheat - _this.heatPart, 0);
            debug('Cooling down overall queue', _this.overheat);
        }, this.heatPart);
    };
    SmartQueue.prototype.findMostImportant = function (bestQueue) {
        return __awaiter(this, void 0, void 0, function () {
            var maximumPriority, selectedQueue, minimalCooldown;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.queue.forEach(function (queue) {
                            if (queue.rule.priority < maximumPriority && queue.data.length && _this.isCool(queue)) {
                        ...
                        if (!(minimalCooldown > 0 && minimalCooldown !== Infinity)) return [3 /*break*/, 2];
                        debug('Waiting for cooldown', minimalCooldown);
                        return [4 /*yield*/, this.delay(minimalCooldown)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.delay(this.overheat)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, this.findMostImportant()];
                    case 4:
    ...
    SmartQueue.prototype.setCooldown = function (queue, part) {
        var _this = this;
        if (part === void 0) { part = 0; }
        var ruleData = this.params.rules[queue.ruleName];
        var cooldown = (ruleData.limit * 1000) / ruleData.rate;
        if (part >= cooldown) {
    ...
    SmartQueue.prototype.isCool = function (queue) {
        var cooldown = (queue.rule.limit * 1000) / queue.rule.rate;
